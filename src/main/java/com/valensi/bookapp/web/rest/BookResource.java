...
import com.valensi.bookapp.domain.Book;
import com.valensi.bookapp.repository.BookRepository;
...
/**
 * REST controller for managing {@link com.valensi.bookapp.domain.Book}.
 */
@RestController
@RequestMapping("/api")
@Transactional
